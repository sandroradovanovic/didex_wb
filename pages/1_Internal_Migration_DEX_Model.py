...
st.markdown(
    '''
    The final DIDEX extracted DEX model for internal migration management is shown below. Triangles represent concepts that are available in existing data, while sqaures represent derived concepts that are calculated using the table of decision rules.
...
st.markdown(
    '''
    The above table can be read as follows: If **Social Factors** are *Poor* and whatever the value for the attribute **Doctors Accessibility** the value of factor **Health and Social Factors** will be Poor. If **Social Factors** is *Medium* and if the value of **Doctors Accessibility** is *Good* or lower than that value (i.e. *Medium* or *Poor*) then the factor **Health and Social Factors** will be Medium. A *Good* value of the resulting factor is achieved in two cases. When the factor **Social Factors** is *Medium* or *Good*, and the attribute **Doctors Accessibility** is *Unknown*, or when the factor **Social Factors** is *Good*.
    '''
)

df_2 = [['Poor', '<= Medium', 'Poor'], ['<= Medium', '>= Good', 'Medium'], ['Medium', '*', 'Medium'], ['>= Medium', 'Poor', 'Medium'], ['>= Good', '>= Medium', 'Good']]
df_2 = pd.DataFrame(df_2, columns = ['Social factors', 'Doctors Accessibility', 'Health and Social Factors'])
...
df_7 = [['Poor', '*', 'Poor'], ['Medium', '*', 'Medium'], ['Medium:Uknown', '<= Medium', 'Medium'], ['>= Medium', 'Poor', 'Medium'], ['>= Unknown', '>= Good', 'Good'], ['Good', '>= Medium', 'Good']]
